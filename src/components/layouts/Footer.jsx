        ...
        <div className="mt-20 rounded-3xl border border-white/10 bg-white/5 p-8 backdrop-blur-xl">
          ...
          <div className="flex flex-col items-center justify-between gap-8 lg:flex-row">
            ...
            <div className="flex w-full max-w-xl">
              ...
              <button className="flex items-center gap-2 rounded-r-xl bg-gradient-to-r from-cyan-500 to-blue-600 px-6 font-semibold text-white transition hover:scale-105">
          ...
          <div className="flex gap-4">
            ...
            {[
              ...
              <a
                key={index}
                href="#"
                className="rounded-xl border border-white/10 bg-white/5 p-3 transition hover:border-cyan-400 hover:bg-cyan-500/10 hover:text-cyan-400"
              >
                <Icon size={18} />
              </a>
